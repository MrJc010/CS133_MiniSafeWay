...
public class CartAdapter extends RecyclerView.Adapter<CartViewHolder>{
    ...
    public void onBindViewHolder(CartViewHolder holder, int position) {
        ...
        double price = (Double.parseDouble(listData.get(position).getPrice()) - Double.parseDouble(listData.get(position).getDiscount()))*(Double.parseDouble((listData.get(position).getQuantity())));
